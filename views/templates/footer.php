    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-3 col-md-6 mb-4 mb-lg-0">
                <img src="<?= BASEURL; ?>/image/polije.png" alt="Logo Footer" class="footer-logo">
                <p class="footer-text">
                    ...
                    <br><br>
                    Mahasiswa terlibat langsung dalam proses produksi, pengemasan, hingga pemasaran produk susu siap konsumsi.
                </p>
            </div>

            <!-- TEFA MILK Info -->
            <div class="col-lg-3 col-md-6 mb-4 mb-lg-0">
                <h5 class="footer-heading">TEFA MILK</h5>
            ...
            <div class="col-lg-3 col-md-6 mb-4 mb-lg-0">
                ...
                <ul class="footer-social">
                    <li>
                        <a href="https://www.instagram.com/_jokoest?igsh=MWp5anBzaXV0MnJsMQ==" target="_blank">
                            <i class="fab fa-instagram"></i>
                            <span>Instagram</span>
                        </a>
                    </li>
                    <li>
                        <a href="https://www.facebook.com/share/17yNHUZbAp/" target="_blank">
                            <i class="fab fa-facebook"></i>
                            <span>Facebook</span>
                        </a>
                    </li>
                    <li>
                        <a href="https://youtube.com/@polijesip?si=0WnHTrgRa2TBOmU2" target="_blank">
                            <i class="fab fa-youtube"></i>
                            <span>Youtube</span>
                        </a>
                    </li>
                    <li>
                        <a href="https://wa.me/6287729664976" target="_blank">
    ...
    <div class="footer-bottom">
        <div class="container">
            <p class="text-center py-4 mb-0">
                © 2026 TEFA MILK. All rights reserved. <br>
                <small class="d-block mt-1">Made with jokoest </small>
            </p>
        </div>
    </div>
</footer>
